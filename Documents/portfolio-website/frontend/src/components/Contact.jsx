        ...
        <div className="contact-content">
          <div className="contact-info">
            ...
            <div className="contact-social">
              <a href={data.github} target="_blank" rel="noopener noreferrer" className="contact-social-link">
              ...
              <a href={data.linkedin} target="_blank" rel="noopener noreferrer" className="contact-social-link">
                <svg viewBox="0 0 24 24" fill="currentColor">
